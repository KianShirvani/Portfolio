...
<div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
  ...
  >
    <Image src={assets.profile_img} alt="" className="mx-auto rounded-full w-64 mt-10" />

  </motion.div>
    <motion.h3
  initial={{y: -20, opacity: 0}}
  whileInView={{y: 0, opacity: 1}}
  transition={{duration:0.8, delay: 0.5}}    className="mt-4 mx-auto flex items-end justify-center gap-2 text-xl md:text-2xl mb-3 font-Ovo">
